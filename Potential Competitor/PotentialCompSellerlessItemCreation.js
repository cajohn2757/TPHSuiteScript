/*
*
* Purpose: Create Potential Competitor Item Record in Item Master Even without a Seller ID
...
function main() {
  ...
  for (var i in potentCompToCreate) {
    ...
    var brandRecordID = createBrandRecord(brand);
...
[
   ...
   "AND", 
   ["custrecord_tph_potential_comp_ns_brand","noneof","@NONE@"]
], 
[
   ...
   new nlobjSearchColumn("name","custrecord_tph_potential_comp_ns_brand"), //columns[9]
...
function createBrandRecord(Brand) {

  var brandIDSearchResult = brandIDSearch(Brand);
  ...
  if(brandIDSearchResult != undefined) {
    ...
    */
    var recordID = null;
    nlapiLogExecution('debug', 'End', 'No Brand Matches for ' + Brand);
  }
